import { create_rectangle, query_position, update_position, 
    ...
    get_game_time, update_text, create_audio, play_audio
} from "arcade_2d";
...
function check_A_collison(){
    if((gameobjects_overlap(shuttle_bus1, playerA) || gameobjects_overlap(shuttle_bus2, playerA))&& num_of_life_A > 0){
...
function check_B_collison(){
    if((gameobjects_overlap(shuttle_bus1, playerB) || gameobjects_overlap(shuttle_bus2, playerB)) && num_of_life_B > 0){
        play_audio(hit_sound);
