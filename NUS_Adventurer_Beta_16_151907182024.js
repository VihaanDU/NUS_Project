import { create_rectangle, query_position, update_position, 
    ...
    get_game_time, update_text, create_audio, play_audio, loop_audio
} from "arcade_2d";
...
const length = 1950;
const width = 1600;
const total_num_of_coins = 35; // change the number of the coins if needed
...
const Entrance_A = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/EntranceA.png"), [0.35, 0.35]), [125, 1025]);
const Entrance_D = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/EntranceD.png"), [0.35, 0.35]), [1450, 215]);
...
// ************************************************
const middle_Bush_1 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush.PNG"), [0.35, 0.35]), [662, 312]);
const middle_Bush_6 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush.PNG"), [0.35, 0.35]), [1002, 312]);


const upperMid_bush12 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [625, 500]);
const upperMid_bush13 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [800, 500]);
const upperMid_bush14 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [975, 500]);
const upperMid_bush15 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [1150, 500]);
const upperMid_bush16 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [1340, 500]);
const upperMid_bush21 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.3, 0.3]), [690, 509]);
const upperMid_bush22 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.3, 0.3]), [865, 509]);
const upperMid_bush23 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.3, 0.3]), [1040, 509]);
const upperMid_bush24 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.3, 0.3]), [1215, 509]);
const upperMid_bush31 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush3.PNG"), [0.2, 0.2]), [747, 505]);
const upperMid_bush32 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush3.PNG"), [0.2, 0.2]), [927, 505]);
const upperMid_bush33 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush3.PNG"), [0.2, 0.2]), [1100, 505]);
const upperMid_bush34 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush3.PNG"), [0.2, 0.2]), [1287, 505]);

const middle_Tree_1 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [663, 610]);
const middle_Tree_12 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [1000, 800]);
const middle_Tree_3 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [930, 600]);
const middle_Tree_4 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [1200, 650]);
const middle_Tree_5 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [750, 1000]);
const middle_Tree_6 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [970, 1050]);

const right_Tree_1 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [1640, 550]);
const right_Tree_7 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.4, 0.4]), [1600, 1050]);
const right_Tree_8 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Tree.PNG"), [0.35, 0.35]), [1840, 1060]);
const left_Bush_1 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush.PNG"), [0.27, 0.27]), [20, 500]);
const left_Bush_2 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush.PNG"), [0.27, 0.27]), [70, 500]);
const left_Bush_3 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush.PNG"), [0.27, 0.27]), [140, 500]);
const left_Bush_4 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush.PNG"), [0.27, 0.27]), [175, 500]);

const left_decorbush1 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.4, 0.4]), [100, 650]);
const left_decorbush2 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.4, 0.4]), [310, 760]);
const left_decorbush3 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.4, 0.4]), [320, 900]);
const left_decorbush5 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.4, 0.4]), [65, 820]);

const right_decorbush1 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.4, 0.4]), [1730, 590]);
const right_decorbush2 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush2.PNG"), [0.4, 0.4]), [1950, 620]);
const right_decorbush3 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.4, 0.4]), [1725, 990]);
const right_decorbush4 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [320, 900]);
const right_decorbush5 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Bush1.PNG"), [0.3, 0.3]), [320, 900]);
// ************************************************
// Initializing all coins
const coin_array = [];
for(let i = 0; i < total_num_of_coins; i = i + 1){
    if(i > 10 && i < 20){
        coin_array[array_length(coin_array)] = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]), [i * 80, 450]);
    } else if(i >= 20 && i < 30) {
        coin_array[array_length(coin_array)] = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]), [530, (i - 18) * 80]);
    }
    else {
        coin_array[array_length(coin_array)] = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Coins_test.png"), [0.05, 0.05]), [math_random() * 1550, math_random() * 1100]);
    }
}
...
const playerA = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/nus_stu.png"), [0.2, 0.2]), defaultA);
const playerB = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/NusMascOri_Updated.PNG"), [0.35, 0.35]), defaultB);
const explorer = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Merlion_Updated.png"), [0.25, 0.25]), [350, 1500]);
...
const shuttle_bus2 = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Opp_NUS%20BUS.png"), [0.125, 0.125]), [0, 1200]);
const car = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/Car.png"), [0.08, 0.08]), [530, 0]);
const the_Helicopter = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/update_Welcome%20to%20NUS.png"), [0.4, 0.4]), [0, width / 2]);
...
const info_tied = update_position(update_scale(create_sprite("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/GAME%20OVER%20TIED_Updated.png"), [1.2, 1.2]), Far);
...
const hit_sound = create_audio("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/BUS_Hit%20(V0).mp3", 1);
...
function check_A_collison(){
    if((gameobjects_overlap(shuttle_bus1, playerA) || gameobjects_overlap(shuttle_bus2, playerA) || gameobjects_overlap(car, playerA)) && num_of_life_A > 0){
...
function check_B_collison(){
    if((gameobjects_overlap(shuttle_bus1, playerB) || gameobjects_overlap(shuttle_bus2, playerB) || gameobjects_overlap(car, playerB)) && num_of_life_B > 0){
        play_audio(hit_sound);
...
function B_win(){
    ...
    update_position(update_text(f_score_A, stringify(num_of_coins_A)), [length / 2 + 125, width / 2 + 192]);
    update_position(update_text(f_score_B, stringify(num_of_coins_B)), [length / 2 + 125, width / 2 + 252]);
}
function tied(){
    update_position(info_tied, [length / 2, width / 2]);
    update_position(update_text(f_score_A, stringify(num_of_coins_A)), [length / 2 + 140, width / 2 + 272]);
    update_position(update_text(f_score_B, stringify(num_of_coins_B)), [length / 2 + 140, width / 2 + 352]);
}
...
play_audio(loop_audio(create_audio("https://raw.githubusercontent.com/VihaanDU/NUS_Project/main/bit-shift-kevin-macleod-main-version-24901-03-12.mp3", 0.1)));
...
// Update GameObjects within update_loop
    ...
    update_position(shuttle_bus2, boundary_check([get_game_time()/2, 1200]));
    update_position(car, boundary_check([530, width - get_game_time()/2]));
